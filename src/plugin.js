      ...
      if (_specialProps[p] === 2) {
        ...
        if ((val.length > 3 || sp.proxy.a !== 1) && sp.proxy.a !== val[3]) {
          this._addTween(
            ...
            "a",
            sp.proxy.a,
            val.length > 3 ? val[3] : 1,
            p
          );
        }
      } else if (p === "bezier") {
        bezierPlugin = MotionPathPlugin;
        if (!bezierPlugin) {
        ...
        this._overwriteProps = this._overwriteProps.concat(
          bezierPlugin._overwriteProps
        );
        ...
        directionalRotationPlugin = this._directionalRotation =
        ...
        this._addTween(
          ...
          (typeof target[p] === "function"
            ? target[
                gp !== "get" && typeof target[gp] === "function" ? gp : p
              ]()
            : target[p]) || 0,
          val,
          p
